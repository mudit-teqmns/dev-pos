...
import { SUBSCRIPTION_PLANS, formatPrice, stripePromise, type SubscriptionPlan } from '../lib/stripe'
    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-4">
        <div className="flex items-center gap-2 text-red-800">
          ...
          <h3 className="font-semibold">Stripe Configuration Required</h3>
        </div>
        <p className="text-red-700 mt-2">
          Please configure your Stripe publishable key in the environment variables to enable payments.
        </p>
      </div>
    )
  }
